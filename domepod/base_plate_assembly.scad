...
module base_plate_assembly()
{
    difference(){
        ...
        union(){
            ...
            translate([0, 0, 13.01])
                base_plate_middle(height=3.02);

            translate([0, 0, 8+0.01])
                base_plate_middle(height=5.02,raspi_base=true, raspi_hole=6.2);

            translate([0, 0, 8-1.4+0.01])
                base_plate_middle(height=1.42,raspi_base=true, raspi_hole=2.7);
            
            translate([0, 0, 5+0.01])
                base_plate_middle(height=1.62);
